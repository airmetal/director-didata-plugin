...
import static com.cloudera.director.dimensiondata.sql.GoogleCloudSQLInstanceTemplateConfigurationProperty.PREFERRED_LOCATION;
import static com.cloudera.director.dimensiondata.sql.GoogleCloudSQLInstanceTemplateConfigurationProperty.TIER;
import static com.cloudera.director.dimensiondata.sql.GoogleCloudSQLInstanceTemplateConfigurationValidator.INVALID_NAME_LENGTH_MSG;
import static com.cloudera.director.dimensiondata.sql.GoogleCloudSQLInstanceTemplateConfigurationValidator.INVALID_NAME_MSG;
import static com.cloudera.director.dimensiondata.sql.GoogleCloudSQLInstanceTemplateConfigurationValidator.INVALID_PREFIX_LENGTH_MSG;
import static com.cloudera.director.dimensiondata.sql.GoogleCloudSQLInstanceTemplateConfigurationValidator.INVALID_PREFIX_MSG;
import static com.cloudera.director.dimensiondata.sql.GoogleCloudSQLInstanceTemplateConfigurationValidator.INVALID_TIER_MSG;
import static com.cloudera.director.dimensiondata.sql.GoogleCloudSQLInstanceTemplateConfigurationValidator.PREFERRED_LOCATION_NOT_FOUND_IN_REGION_MSG;
import static com.cloudera.director.dimensiondata.sql.GoogleCloudSQLInstanceTemplateConfigurationValidator.PREFERRED_LOCATION_NOT_FOUND_MSG;
import static com.cloudera.director.dimensiondata.sql.GoogleCloudSQLInstanceTemplateConfigurationValidator.PREFIX_MISSING_MSG;
...
import com.cloudera.director.dimensiondata.shaded.com.google.api.services.compute.model.Zone;
import com.cloudera.director.dimensiondata.shaded.com.google.api.services.sqladmin.SQLAdmin;
import com.cloudera.director.dimensiondata.shaded.com.google.api.services.sqladmin.model.Tier;
import com.cloudera.director.dimensiondata.shaded.com.google.api.services.sqladmin.model.TiersListResponse;
