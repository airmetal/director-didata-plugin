...
import static com.cloudera.director.dimensiondata.compute.GoogleComputeInstanceTemplateConfigurationProperty.BOOT_DISK_TYPE;
import static com.cloudera.director.dimensiondata.compute.GoogleComputeInstanceTemplateConfigurationProperty.DATA_DISK_COUNT;
import static com.cloudera.director.dimensiondata.compute.GoogleComputeInstanceTemplateConfigurationProperty.DATA_DISK_SIZE_GB;
import static com.cloudera.director.dimensiondata.compute.GoogleComputeInstanceTemplateConfigurationProperty.DATA_DISK_TYPE;
import static com.cloudera.director.dimensiondata.compute.GoogleComputeInstanceTemplateConfigurationProperty.IMAGE;
import static com.cloudera.director.dimensiondata.compute.GoogleComputeInstanceTemplateConfigurationProperty.NETWORK_NAME;
import static com.cloudera.director.dimensiondata.compute.GoogleComputeInstanceTemplateConfigurationProperty.TYPE;
import static com.cloudera.director.dimensiondata.compute.GoogleComputeInstanceTemplateConfigurationProperty.ZONE;
import static com.cloudera.director.dimensiondata.compute.GoogleComputeProviderConfigurationProperty.REGION;
...
import com.cloudera.director.dimensiondata.shaded.com.google.api.services.compute.Compute;
import com.cloudera.director.dimensiondata.shaded.com.google.api.services.compute.model.AttachedDisk;
import com.cloudera.director.dimensiondata.shaded.com.google.api.services.compute.model.AttachedDiskInitializeParams;
import com.cloudera.director.dimensiondata.shaded.com.google.api.services.compute.model.Disk;
import com.cloudera.director.dimensiondata.shaded.com.google.api.services.compute.model.Instance;
import com.cloudera.director.dimensiondata.shaded.com.google.api.services.compute.model.NetworkInterface;
import com.cloudera.director.dimensiondata.shaded.com.google.api.services.compute.model.Operation;
